...
function createMcpServer(channel: vscode.OutputChannel): McpServer {
  ...
  server.registerResource(
    'lmToolsNames',
    'lm-tools://tool-names',
    { description: 'Read enabled bridged workspace tool names. This is names-only discovery; fetch ToolDefinitions with lmToolsBridge.getToolDefinitions before calling bridged tools.' },
    async () => {

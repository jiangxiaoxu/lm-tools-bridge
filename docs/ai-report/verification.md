...
- Happy path: bind, unknown-only ToolDefinition lookup, dynamic `tools/list`, bridged direct call, diagnostics, qgrep status, qgrep text search, and qgrep file search.

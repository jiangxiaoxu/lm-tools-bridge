...
- `lmToolsBridge.bindWorkspace` description also acts as the first trigger hint: when the task looks like legacy `vscode-tools` work such as workspace search, code navigation, diagnostics, or VS Code IDE actions, agents should start the bridge flow from this tool.

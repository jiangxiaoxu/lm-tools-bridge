...
- If enabled, `lm_formatFiles` formats the files selected by `pathScope`, applies edits, and saves changed files.
...
- 如果已经启用 `lm_formatFiles`,它会按 `pathScope` 选择文件,执行 format 并保存变更.

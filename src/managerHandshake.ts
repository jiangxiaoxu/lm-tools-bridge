export interface HandshakeDiscoveryBridgedTool {
  name: string;
}

// Keep callTool separate so bridgedTools can stay names-only in handshake payloads.
export interface HandshakeDiscoveryCallTool {
  name: string;
  description: string;
